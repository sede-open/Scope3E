...
const getOption = (relationship: any) => ({
  label: relationship.customer.name,
  value: relationship.customer.id,
});

describe('getCustomerProps', () => {
  it('should return an array of customer company options, sorted by customer name', () => {
